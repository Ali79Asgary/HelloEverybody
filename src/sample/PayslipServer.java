...
public class PayslipServer {
    ...
    private void createPayslip(String personId, String currentTime) throws SQLException
    {
        ...
        PreparedStatement prs = con.prepareStatement("insert into payslipAction " +
                "(payslipId, owner, houseHelp, transferHelp, groceryHelp, missionHelp, salary, actionId, lunchHelp) " +
                "values(?,?,?,?,?,?,?,?,?); ");
    ...
    private double getTransferHelp(String personId, int minimumSalary) throws SQLException
    {
        Statement stm = con.createStatement();
    ...
    private double getHouseHelp(String personId, int minimumSalary) throws SQLException
    {
        Statement stm = con.createStatement();
        String query = String.format("select city from teachers where personId='%s';", personId);
        ResultSet rs = stm.executeQuery(query);
    ...
    private static boolean isInDevelopedCity(int cityCode)
    {
    ...
    private void updateTime(String newTime) throws SQLException
    {
        Statement st = con.createStatement();
        String query = String.format("update time set currentTime='%s' WHERE time.variable='currentTime';",newTime);
        st.executeUpdate(query);
    }
    private ObservableList<String> getEmployees() throws SQLException
    {
    ...
    private ResultSet getPersonAction(String personId) throws SQLException
    {
    ...
    private int getChildrenHelp(String personId, int minimumSalary) throws SQLException
    {
        Statement stm = con.createStatement();
